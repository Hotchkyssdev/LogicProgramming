...
Declara variables de todos los tipos primitivos en Java (int, double, float, long, byte, char, boolean) 
y muestra su valor en consola con mensajes descriptivos. */

public class Ejercicio20 {
    public static void main(String[] args) {
        int entero = 15;
        double doble = 15.99;
        float flotante = 15.995f;
        long largo = 1500000L;
        byte b =  27;
        char caracter = 'H';
        ...
        System.out.println("El valor de byte es: " + b);
